...
#define MAX_PARTICLES 2005
#define NDIM 3
#define OUTPUT_INTERVAL 100.0
...
int main(int argc, char *argv[])
{
    ...
    fprintf(orbit_file, "time,particle_id,a,e,inc_deg,asc_deg,per_deg\n");
